...
const events = [
      ...
      {id:"mota-bremen",theater:"west",sortDate:"1943-06-25",date:"1943년 6월 25일",title:"브레멘 첫 출격",series:"mota",episode:"1",summary:"제100폭격단이 브레멘 잠수함 조선소를 향해 첫 전투 임무에 나서지만 구름과 독일군 공격으로 큰 손실을 입음.",detail:"[1화] 제100폭격단이 영국 소프 애보츠에 도착해 제8공군의 주간폭격 작전에 합류한다. 6월 25일 첫 전투 임무로 브레멘의 잠수함 조선소를 향하지만 두꺼운 구름 때문에 노든 폭격조준기로 목표를 확인하지 못해 폭격을 중단한다. 귀환 중 대공포와 독일 전투기의 공격으로 B-17 3대와 승무원 30명을 잃으며 전쟁의 현실을 처음 겪는다.",routes:[["소프 애보츠",0.98,52.28,"브레멘",8.8,53.08,"mota","air"]]},
      {id:"mota-trondheim",theater:"west",sortDate:"1943-07-24",date:"1943년 7월 24일",title:"트론헤임 잠수함 기지 폭격",series:"mota",episode:"2",summary:"노르웨이 트론헤임 잠수함 기지를 공격하고, 크로스비의 항법으로 손상된 B-17이 영국에 귀환함.",detail:"[2화] 제100폭격단이 당시 제8공군 최장거리급 임무였던 노르웨이 트론헤임 잠수함 기지 폭격에 나선다. 귀환 중 커티스 비딕의 B-17이 심하게 손상되어 편대에서 뒤처지지만, 크로스비의 항법으로 부대가 영국 방향을 찾아 귀환하고 비딕의 기체도 스코틀랜드에 비상착륙한다.",routes:[["소프 애보츠",0.98,52.28,"트론헤임",10.4,63.43,"mota","air"]]},
      {id:"mota-regensburg",theater:"west",sortDate:"1943-08-17",date:"1943년 8월 17일",title:"레겐스부르크 셔틀 폭격",series:"mota",episode:"3",summary:"메서슈미트 Bf 109 공장을 폭격한 뒤 북아프리카로 향하는 장거리 임무에서 큰 손실을 입음.",detail:"[3화] 슈바인푸르트-레겐스부르크 공습의 일부로, 제100폭격단이 독일 깊숙한 레겐스부르크의 메서슈미트 Bf 109 생산공장을 공격한다. 호위 전투기의 항속거리 밖에서 독일 전투기의 집중 공격을 받고 큰 피해를 입은 뒤 알프스를 넘어 북아프리카로 향한다.",routes:[["소프 애보츠",0.98,52.28,"레겐스부르크",12.1,49.02,"mota","air"],["레겐스부르크",12.1,49.02,"북아프리카",9.5,35.5,"mota","air"]]},
      {id:"mota-bremen-second",theater:"west",sortDate:"1943-10-08",date:"1943년 10월 8일",title:"브레멘 재공격",series:"mota",episode:"4",summary:"로버트 ‘로지’ 로젠탈이 합류한 가운데 브레멘 잠수함 시설을 다시 공격하고 손실이 누적됨.",detail:"[4화] 로버트 ‘로지’ 로젠탈이 제100폭격단에 합류한다. 10월 8일 브레멘 잠수함 시설 재공격에서 독일 전투기와 대공포의 집중 공격을 받아 7대를 잃고, 게일 ‘벅’ 클레븐도 격추된다. 이런 반복적인 대손실을 거치며 ‘블러디 헌드레드’라는 별명이 굳어진다.",routes:[["소프 애보츠",0.98,52.28,"브레멘",8.8,53.08,"mota","air"]]},
      {id:"mota-munster",theater:"west",sortDate:"1943-10-10",date:"1943년 10월 10일",title:"뮌스터 폭격 · 검은 주간",series:"mota",episode:"5",summary:"뮌스터 공습에서 출격한 제100폭격단 B-17 13대 중 로젠탈의 기체 한 대만 영국으로 귀환함.",detail:"[5화] 브레멘 공습 이틀 뒤 제100폭격단은 뮌스터를 공격한다. 출격한 B-17 13대 가운데 로젠탈의 ‘로지스 리벳츠’ 한 대만 영국으로 돌아오는 궤멸적 손실을 입고, 버키 이건도 격추되어 포로가 된다. 크로스비는 집단 항법사로 승진하지만 전우들을 잃은 충격과 과로에 무너진다.",routes:[["소프 애보츠",0.98,52.28,"뮌스터",7.63,51.96,"mota","air"]]},
      {id:"mota-stalag-rest",theater:"west",sortDate:"1943-10-11",date:"1943년 10월 이후~1944년 초",title:"포로 이송과 전투 휴양",series:"mota",episode:"6",summary:"격추된 이건은 포로로 붙잡혀 심문소를 거쳐 슈탈라크 루프트 III로 이송되고, 로젠탈 승무원은 전투 피로 회복을 위해 휴양함.",detail:"[6화] 뮌스터 공습에서 탈출한 이건은 베스트팔렌에 낙하한 뒤 독일군 포로가 된다. 다른 포로들과 이동하던 중 폭격 피해를 입은 도시에서 민간인들에게 살해될 위기를 겪고, 오버우어젤의 둘라크 루프트 심문소를 거쳐 자간의 슈탈라크 루프트 III로 이송된다. 그곳에서 먼저 격추된 클레븐과 재회한다. 로젠탈과 승무원은 영국의 휴양 시설에서 누적된 전투 피로와 심리적 상처를 마주한다.",mapDesign:"war-v1",mapView:[[5,48],[17,48],[17,53],[5,53]],countrySides:{"276":"axis","826":"allied"},routes:[["베스트팔렌 격추지",7.63,51.96,"둘라크 루프트",8.58,50.2,"allied","ground"],["둘라크 루프트",8.58,50.2,"슈탈라크 루프트 III",15.31,51.6,"allied","ground"]],units:[],legend:{title:"표현 범례",territories:[{side:"axis",label:"독일 영역"}],routes:[{side:"allied",label:"포로 이송 경로"}],units:[],colors:[{side:"allied",label:"파랑: 연합군 포로"}]}},
      {id:"mota-berlin",theater:"west",sortDate:"1944-03-06",date:"1944년 3월 6일",title:"베를린 대공습",series:"mota",episode:"7",summary:"제8공군이 장거리 호위 전투기와 함께 베를린을 주간 폭격하고, 포로들은 외부 소식과 탈출 가능성을 찾음.",detail:"[7화] P-51 무스탕의 장거리 호위 아래 제8공군이 독일 수도 베를린을 대규모로 폭격한다. 제100폭격단 역시 큰 손실을 입는다. 한편 슈탈라크 루프트 III의 포로들은 외부와 연락하고 탈출을 준비하며, 로젠탈은 위험을 알면서도 추가 전투 임무를 선택한다.",routes:[["소프 애보츠",0.98,52.28,"베를린",13.41,52.52,"mota","air"]]},
      {id:"mota-dday-tuskegee",theater:"west",sortDate:"1944-06-06",date:"1944년 6월~8월",title:"D-Day 지원과 터스키기 항공대",series:"mota",episode:"8",summary:"제100폭격단은 노르망디 상륙을 지원하고, 터스키기 조종사들은 남프랑스 작전 중 격추되어 포로수용소로 향함.",detail:"[8화] 6월 6일 D-Day를 전후해 제100폭격단은 프랑스의 교통망과 독일 방어시설을 공격해 상륙군을 지원한다. 별도의 시간대인 8월에는 터스키기 항공대 조종사들이 남프랑스의 레이더 시설 공격과 호위 임무에 참가한다. 일부가 격추·포로가 되어 슈탈라크 루프트 III에서 클레븐과 이건을 만난다.",routes:[["소프 애보츠",0.98,52.28,"노르망디",-0.5,49.3,"mota","air"],["라미텔리",15.1,41.92,"툴롱",5.93,43.12,"mota","air"]]},
      {id:"mota-war-end",theater:"west",sortDate:"1945-02-03",date:"1945년 2월 3일~5월",title:"베를린 공습과 종전",series:"mota",episode:"9",summary:"로젠탈의 베를린 공습·격추와 포로들의 겨울 강제행군 및 해방을 거쳐 유럽 전쟁이 끝남.",detail:"[9화] 1945년 2월 3일 로젠탈은 베를린 공습을 지휘하다 격추되어 소련군 지역에 내려온다. 동쪽에서 소련군이 접근하자 독일군은 슈탈라크 루프트 III 포로들을 혹한 속에서 서쪽으로 강제 이동시키고, 포로들은 끝내 연합군에 해방된다. 제100폭격단은 네덜란드 식량 투하 등 마지막 임무를 수행하고 생존자들이 귀환하며 이야기가 끝난다.",routes:[["소프 애보츠",0.98,52.28,"베를린",13.41,52.52,"mota","air"],["슈탈라크 루프트 III",15.31,51.6,"무스부르크",11.94,48.47,"mota","air"]]},
...
const detailedMapPresets = {
  ...
  "mota-trondheim":{countries:"mota",sides:"mota",types:"air",view:[[-3,51],[13,51],[13,65],[-3,65]]},
  "mota-regensburg":{countries:"mota",sides:"mota",types:"air",view:[[-2,34],[15,34],[15,54],[-2,54]]},
  "mota-bremen-second":{countries:"mota",sides:"mota",types:"air",view:[[-2,50],[12,50],[12,55],[-2,55]]},
  ...
  "mota-dday-tuskegee":{countries:"mota",sides:"mota",types:"air",view:[[-3,40],[17,40],[17,54],[-3,54]]},
  "mota-war-end":{countries:"berlin",sides:"mota",types:"air",view:[[-2,47],[18,47],[18,54],[-2,54]]},
